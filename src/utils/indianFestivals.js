...
export const FESTIVAL_TYPES = {
  national: { label: 'National Holiday', color: '#FF9933', emoji: '🇮🇳', bg: 'rgba(255,153,51,0.15)' },
  hindu:    { label: 'Hindu Festival',   color: '#DC2626', emoji: '🪔', bg: 'rgba(220,38,38,0.12)' },
  muslim:   { label: 'Muslim Festival',  color: '#16A34A', emoji: '🌙', bg: 'rgba(22,163,74,0.12)' },
  sikh:     { label: 'Sikh Festival',    color: '#9333EA', emoji: '☬',  bg: 'rgba(147,51,234,0.12)' },
  christian:{ label: 'Christian Festival',color: '#2563EB', emoji: '✝️', bg: 'rgba(37,99,235,0.12)' },
  buddhist: { label: 'Buddhist Festival',color: '#D97706', emoji: '☸️', bg: 'rgba(217,119,6,0.12)' },
  jain:     { label: 'Jain Festival',    color: '#0891B2', emoji: '🕉️', bg: 'rgba(8,145,178,0.12)' },
};
